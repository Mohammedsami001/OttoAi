...
from main.repositories.daily_summaries import DailySummariesRepository, get_daily_summaries_repo
from main.repositories.spending import SpendingRepository, get_spending_repo
...
async def dashboard_summary(
    ...
    spending_repo: SpendingRepository = Depends(get_spending_repo),
    integrations_repo: IntegrationsRepository = Depends(get_integrations_repo),
    daily_summaries_repo: DailySummariesRepository = Depends(get_daily_summaries_repo)
):
    ...
    await daily_summaries_repo.upsert_daily_summary(user_id, today, payload)
