  ...
  const plans = [
    {
      name: "Free",
      price: "$0",
      description: "For your personal operations",
      features: [
        "Basic AI inbox summaries (daily limits)",
        "Calendar booking sync & Meet creation",
    ...
    },
    {
      ...
      features: [
        "Unlimited AI inbox summaries & smart replies",
        "Advanced calendar conflict resolution",
        "AI-powered Google Docs summaries",
    ...
    },
    {
      ...
      features: [
        "All Pro features for multiple members",
